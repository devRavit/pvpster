...
PvPster.LOCALE_REGISTRY.strings[KEY] = {
    ...
    ["RACE_ORC"] = "Ork",
    ["RACE_SCOURGE"] = "Untoter",
    ["RACE_TAUREN"] = "Tauren",
    ["RACE_TROLL"] = "Troll",
    ["RACE_BLOODELF"] = "Blutelf",
    ["RACE_GOBLIN"] = "Goblin",
    ["RACE_VOIDELF"] = "Leerenelf",
    ["RACE_LIGHTFORGEDDRAENEI"] = "Lichtgeschmiedeter Draenei",
    ["RACE_DARKIRONDWARF"] = "Dunkeleisenzwerg",
    ["RACE_KULTIRAN"] = "Kul Tiraner",
    ["RACE_MECHAGNOME"] = "Mechagnom",
    ["RACE_NIGHTBORNE"] = "Nachtgeborener",
    ["RACE_HIGHMOUNTAINTAUREN"] = "Hochbergtauren",
    ["RACE_MAGHARORC"] = "Mag'har-Ork",
    ["RACE_ZANDALARITROLL"] = "Zandalaritroll",
    ["RACE_VULPERA"] = "Vulpera",
    ["RACE_DRACTHYR"] = "Dracthyr",
    ["RACE_EARTHENDWARF"] = "Irdener",

    ["Stat_Mastery"] = "Meisterschaft",
    ["Stat_Haste"] = "Tempo",
    ["Stat_CritStrike"] = "Kritische Trefferchance",
    ...
    ["Stat_MovementSpeed"] = "Bewegungsgeschwindigkeit",
}
