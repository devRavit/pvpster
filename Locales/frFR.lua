...
PvPster.LOCALE_REGISTRY.strings[KEY] = {
    ...
    ["RACE_HUMAN"] = "Humain",
    ["RACE_DWARF"] = "Nain",
    ["RACE_NIGHTELF"] = "Elfe de la nuit",
    ["RACE_GNOME"] = "Gnome",
    ["RACE_DRAENEI"] = "Draeneï",
    ["RACE_WORGEN"] = "Worgen",
    ["RACE_PANDAREN"] = "Pandaren",
    ["RACE_ORC"] = "Orc",
    ["RACE_SCOURGE"] = "Mort-vivant",
    ["RACE_TAUREN"] = "Tauren",
    ["RACE_TROLL"] = "Troll",
    ["RACE_BLOODELF"] = "Elfe de sang",
    ["RACE_GOBLIN"] = "Gobelin",
    ["RACE_VOIDELF"] = "Elfe du Vide",
    ["RACE_LIGHTFORGEDDRAENEI"] = "Draeneï sancteforge",
    ["RACE_DARKIRONDWARF"] = "Nain sombrefer",
    ["RACE_KULTIRAN"] = "Kultirassien",
    ["RACE_MECHAGNOME"] = "Mécagnome",
    ["RACE_NIGHTBORNE"] = "Sacrenuit",
    ["RACE_HIGHMOUNTAINTAUREN"] = "Tauren de Haut-Roc",
    ["RACE_MAGHARORC"] = "Orc mag'har",
    ["RACE_ZANDALARITROLL"] = "Troll zandalari",
    ["RACE_VULPERA"] = "Vulpérin",
    ["RACE_DRACTHYR"] = "Dracthyr",
    ["RACE_EARTHENDWARF"] = "Terreux",

    ["Stat_Mastery"] = "Maîtrise",
    ["Stat_Haste"] = "Hâte",
    ["Stat_CritStrike"] = "Coup critique",
    ...
    ["Stat_Health"] = "Santé",
    ["Stat_Mana"] = "Mana",
    ["Stat_MaxMana"] = "Mana max.",
    ["Stat_MovementSpeed"] = "Vitesse de déplacement",
}
