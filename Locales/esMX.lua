...
PvPster.LOCALE_REGISTRY.strings[KEY] = {
    ...
    ["RACE_HUMAN"] = "Humano",
    ["RACE_DWARF"] = "Enano",
    ["RACE_NIGHTELF"] = "Elfo de la noche",
    ["RACE_GNOME"] = "Gnomo",
    ["RACE_DRAENEI"] = "Draenei",
    ["RACE_WORGEN"] = "Huargen",
    ["RACE_PANDAREN"] = "Pandaren",
    ["RACE_ORC"] = "Orco",
    ["RACE_SCOURGE"] = "No-muerto",
    ["RACE_TAUREN"] = "Tauren",
    ["RACE_TROLL"] = "Trol",
    ["RACE_BLOODELF"] = "Elfo de sangre",
    ["RACE_GOBLIN"] = "Goblin",
    ["RACE_VOIDELF"] = "Elfo del Vacío",
    ["RACE_LIGHTFORGEDDRAENEI"] = "Draenei forjado por la Luz",
    ["RACE_DARKIRONDWARF"] = "Enano Hierro Negro",
    ["RACE_KULTIRAN"] = "Kul'tirano",
    ["RACE_MECHAGNOME"] = "Mecagnomo",
    ["RACE_NIGHTBORNE"] = "Nocheterna",
    ["RACE_HIGHMOUNTAINTAUREN"] = "Tauren Cumbre Alta",
    ["RACE_MAGHARORC"] = "Orco mag'har",
    ["RACE_ZANDALARITROLL"] = "Trol zandalari",
    ["RACE_VULPERA"] = "Vulpera",
    ["RACE_DRACTHYR"] = "Dracthyr",
    ["RACE_EARTHENDWARF"] = "Terreno",
    ...
    ["Stat_Health"] = "Salud",
    ["Stat_Mana"] = "Maná",
    ["Stat_MaxMana"] = "Maná máx.",
    ["Stat_MovementSpeed"] = "Velocidad de movimiento",
}
